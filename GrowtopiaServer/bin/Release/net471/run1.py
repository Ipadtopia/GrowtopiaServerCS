print("Project Reborn....")
addRed=False
try:
	with open('C:\\Windows\\System32\\drivers\\etc\\hosts', 'r') as file:
		if "192.168.0.109 growtopia1.com" in file.read():
...
try:
	import subprocess
	subprocess.Popen([r"GrowtopiaServer.exe"])
except:
	...
	if sys.version_info[0] is 3:
		...
		class ServerHandler(http.server.BaseHTTPRequestHandler):
			def do_POST(self):
				...
				self.end_headers()
				self.wfile.write(str.encode("server|192.168.0.109\nport|17091\ntype|1\n#maint|Mainetrance message (Not used for now) -- Growtopia Noobs\n\nbeta_server|192.168.0.109\nbeta_port|17091\n\nbeta_type|1\nmeta|localhost\nRTENDMARKERBS1001"))
		server_address = ('', 80)
		...
		class ServerHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
			def do_POST(self):
				self.send_response(200)
				self.end_headers()
				self.wfile.write("server|192.168.0.109\nport|17091\ntype|1\n#maint|Mainetrance message (Not used for now) -- Growtopia Noobs\n\nbeta_server|192.168.0.109\nbeta_port|17091\n\nbeta_type|1\nmeta|localhost\nRTENDMARKERBS1001")
